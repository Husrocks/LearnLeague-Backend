...
def get_friends(
    ...
    # Friend lists are public-within-auth (any authenticated user can view)
...
def add_friend(
    ...
    # T7: only the account owner (or admin) can add friends to an account
...
def remove_friend(
    ...
    # T7: only the account owner (or admin) can remove friends from an account
    assert_owns_or_admin(current_user, user_id)
